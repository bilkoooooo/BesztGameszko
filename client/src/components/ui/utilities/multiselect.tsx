...
import { Command, CommandGroup, CommandItem, CommandList } from "@/components/utilities/command";
...
/**
 * The `CommandEmpty` of shadcn/utilities will cause the cmdk empty not rendering correctly.
